    ...
    <div className="bg-white" ref={passRef} id="countries-div" style={{ overflowX: 'hidden' }}>
      <div className="mx-auto py-8 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div>
          ...
          <input
            type="text"
            className="p-2 mt-4 max-w-md w-full border-2"
        ...
        <div className="mt-12 grid grid-cols-2 gap-y-20 gap-x-6 sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
          {displayedCountries.map((country, index) => (
            <div className="text-center" key={index}>
              ...
              <button className="btn text-center text-white text-sm w-1/2 sm:w-1/3 py-2 max-w-20 bg-[#0B3D59] hover:bg-gradient-to-r from-[#1B75BB] via-[#27A9E1] to-[#49C0B5] rounded-2xl">
