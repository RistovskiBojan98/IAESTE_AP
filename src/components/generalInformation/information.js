...
import countryCode from "./images/country_dialing_code.jpg"
...
export const voltageImgUrl = voltage
export const countryCodeImgUrl = countryCode
export const populationImgUrl = population
