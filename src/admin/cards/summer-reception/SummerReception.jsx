        ...
        <div>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-10 p-1">
                {!!weekends.length && weekends.map((weekend, index) =>
                    <div key={index} className="p-4 bg-[#0B3D59] text-white rounded-md flex flex-col">
                        ...
                        <div className="flex space-x-3 justify-end mt-2">
                            ...
                            <button
                                ...
                                className={`btn flex items-center rounded-full border-2 border-[#1B75BB] p-2 bg-[#F1F1E6] text-black font-semibold`}
                            >
